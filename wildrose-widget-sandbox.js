(() => {
  ...
  root.innerHTML = `
    ...
    <section class="wr-panel" aria-label="${cfg.title}">
      ...
      <main class="wr-view active" data-view="voice"><div class="wr-voice"><div><div class="wr-orb"></div><div class="wr-status">Ready when you are</div><div class="wr-note">Tap start and speak naturally.</div><button class="wr-primary wr-start-voice">Start talking</button><button class="wr-secondary wr-end-voice" style="display:none">End</button><div class="wr-live-transcript"><div class="wr-live-label">Live transcript</div><div class="wr-live-lines"></div></div></div></div></main>
  ...
  function appendVoiceTranscript(role, text, partial = false) {
    ...
    live?.closest(".wr-live-transcript")?.classList.add("has-lines");
