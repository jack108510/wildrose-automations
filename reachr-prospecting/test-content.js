...
assert.match(composeReachrMessage('Example Business'), /^Hey, I’m Jack\./);
assert.match(composeReachrMessage('Example Business'), /Would Example Business be interested/);
